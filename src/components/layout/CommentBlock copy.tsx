        ...
        <div className='flex gap-3 h-full bg-yellow-400'>
            ...
            <div className='w-2/3 flex gap-6'>
                <div className='relative'>
                    <div className='absolute h-10 w-full top-0 rounded-b-2xl bg-white opacity-80'></div>
                    <div className="flex flex-col gap-6 mt-16 mb-16"> 
                        <CommentCard 
                    ...
                    <div className='absolute h-10 w-full bottom-0 rounded-t-2xl bg-white opacity-80'></div>
                </div>
               <div className='relative'>
                    <div className='absolute h-10 w-full top-0 rounded-b-2xl bg-white opacity-80'></div>
